...
def get_category_nature(request):
    ...
    paginator = Paginator(nature_list, 5)
    try:
...
def get_category_animals(request):
    ...
    page = request.GET.get('page', 1)
    paginator = Paginator(animals_list, 5)
    try:
...
def get_category_cities(request):
    ...
    page = request.GET.get('page', 1)
    paginator = Paginator(cities_list, 5)
    try:
...
def get_category_fitness(request):
    ...
    page = request.GET.get('page', 1)
    paginator = Paginator(fitness_list, 5)
    try:
...
def get_category_motorcycles(request):
    ...
    page = request.GET.get('page', 1)
    paginator = Paginator(motorcycles_list, 5)
    try:
...
def get_category_people(request):
    ...
    page = request.GET.get('page', 1)
    paginator = Paginator(people_list, 5)
    try:
...
def get_category_space(request):
    ...
    page = request.GET.get('page', 1)
    paginator = Paginator(space_list, 5)
    try:
...
def get_category_technology(request):
    ...
    page = request.GET.get('page', 1)
    paginator = Paginator(technology_list, 5)
    try:
